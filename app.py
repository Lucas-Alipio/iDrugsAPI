...
blueprint = Blueprint('app', __name__, url_prefix='/idrugs-api')
...
@app.route('/')
def status():
    return jsonify({"message": "IDRUGS-API: Aplicação rodando",
        "/idrugs-api/user": "mostra todos usuários",
        "/idrugs-api/user/<id>": "mostra usuário do id especificado",
    })
